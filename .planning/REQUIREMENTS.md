...
- [x] **TASK-04**: Task detail shows activity timeline (status changes, comments, agent output) and dispatch log
- [x] **TASK-05**: Task detail shows deliverables (uploaded files, code artifacts, links) with preview
- [x] **TASK-06**: User can toggle sign-off gate on tasks (require human approval before DONE)
...
- [x] **FILE-01**: User can browse agent workspace files at `/workspace`
- [x] **FILE-02**: User can view/edit workspace files (SOUL.md, AGENTS.md, etc.) at `/workspace/[agentId]/[...path]`
...
- [x] **SETT-04**: User can manage organization settings, members, and roles at `/settings/team`
- [x] **SETT-05**: User can invite users and manage pending invitations at `/settings/team/invites`
- [x] **SETT-06**: User can manage AXion Hub API keys for external integrations at `/settings/api`
...
- [x] **ADEV-02**: WebSocket playground for testing Gateway WebSocket commands live at `/api-docs/ws`
