...
import { useCreateTask } from "@/features/missions/api/use-task-mutations";
import { useBoardStore } from "@/features/missions/model/board-store";
import {
	taskFormSchema,
	type TaskFormValues,
} from "@/features/missions/schemas/task-schemas";
...
export function MissionCreateView() {
	...
	const onSubmit = useCallback(
		...
		[createTask, activeBoardId, router],
	);
		...
		<div className="flex flex-col h-full">
			...
			<div className="max-w-2xl space-y-6 px-1">
				...
				>
					...
					{/* Description */}
					<div className="space-y-2">
						<Label htmlFor="page-task-description">
							Description
						</Label>
						<textarea
					...
					{/* Reviewer */}
					<div className="space-y-2">
						<Label htmlFor="page-task-reviewer">Reviewer</Label>
						<Input
							id="page-task-reviewer"
					...
					{/* Tags */}
					<div className="space-y-2">
						<Label htmlFor="page-task-tags">Tags</Label>
						<Input
							id="page-task-tags"
